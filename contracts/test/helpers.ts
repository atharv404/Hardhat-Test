    ...
    LayerZeroAdapter 
{
    ...
    // Mapping to track ongoing transactions
    mapping(bytes32 => bool) private _processingTransactions;
    ...
    function initiateSwap(
        ...
        if (_processingTransactions[transactionId]) revert TransactionAlreadyProcessing();
        _processingTransactions[transactionId] = true;
